...
class Diagnostics_HTML():
    ...
    def handler(self, *args):
        ...
        return render_template('diagnostics.html', request=request, session=session, tdarr_inform=self.tdarr_inform, button_dict=button_dict, route_group=route_group, route_groups=route_groups, list=list)
