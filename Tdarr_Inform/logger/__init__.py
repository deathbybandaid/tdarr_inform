...
from Tdarr_Inform.tools import isint, closest_int_from_list, is_jsonable, checkattr
...
class Logger():
    """
    The logging System for tdarr_inform.
    """
    ...
    def __init__(self, settings):
        ...
        logging_config = {
            ...
            'loggers': {
                # all purpose, tdarr_inform root logger
                'tdarr_inform': {
        ...
        self.logger = logging.getLogger('tdarr_inform')
    ...
    def log_filepath(self):
        return os.path.join(self.config.internal["paths"]["logs_dir"], 'tdarr_inform.log')
    ...
    def log_format(self):
        """
        Add Custom tdarr_inform log formatting.
        """
    ...
    def custom_log_levels(self):
        """
        Add Custom tdarr_inform log levels.
        """
        return
