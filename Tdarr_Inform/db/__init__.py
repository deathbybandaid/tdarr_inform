...
class Tdarr_InformValues(BASE):
    __tablename__ = 'tdarr_inform_values'
    __table_args__ = MYSQL_TABLE_ARGS
...
class Tdarr_Informdb(object):
    """
    The Database system for Tdarr_Inform.
    """
    ...
    def __init__(self, settings, logger):
        ...
        try:
            ...
            self.tdarr_inform.logger.error("OperationalError: Unable to connect to database.")
            raise
    ...
    def connect(self):
        if self.type != 'sqlite':
            self.tdarr_inform.logger.warning(
    ...
    def set_tdarr_inform_value(self, item, key, value, namespace='default'):
        """
        Set Tdarr_Inform value.
        """
        ...
        try:
            result = session.query(Tdarr_InformValues) \
                .filter(Tdarr_InformValues.item == item)\
                .filter(Tdarr_InformValues.namespace == namespace)\
                .filter(Tdarr_InformValues.key == key) \
                .one_or_none()
            ...
            # DNE - Insert
                ...
                new_pluginitemvalue = Tdarr_InformValues(item=item, namespace=namespace, key=key, value=value)
    ...
    def get_tdarr_inform_value(self, item, key, namespace='default'):
        """
        Get Tdarr_Inform value.
        """
    ...
    def delete_tdarr_inform_value(self, item, key, namespace='default'):
        """
        Delete Tdarr_Inform value.
        """
